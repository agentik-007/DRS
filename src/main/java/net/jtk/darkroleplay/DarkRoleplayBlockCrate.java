...
public class DarkRoleplayBlockCrate extends BlockContainer {

	public static Block blockCrate;

	public static Object instance;

	public DarkRoleplayBlockCrate() {
		super(Material.wood);
	}

	static {

		blockCrate = new DarkRoleplayBlockCrate().setHardness(2.0F)
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockCrate.blockCrate , 1), "BXB", "X X", "BXB", 'X',Blocks.planks ,'B', Items.iron_ingot);
	}
	
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockCrate, "blockCrate");
...
class customRendererCrate extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockCrate.png");
