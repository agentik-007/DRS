...
public class ManaBar extends Gui {
	...
	*/
	private static final ResourceLocation texturepath = new ResourceLocation(DarkRoleplay.MODID, "textures/guis/ManaBar.png");
	...
	DarkRPExtendedPlayer props = DarkRPExtendedPlayer.get(this.mc.thePlayer);
