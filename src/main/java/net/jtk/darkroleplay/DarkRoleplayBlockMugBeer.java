...
public class DarkRoleplayBlockMugBeer extends BlockContainer {

	public static Block blockMugBeer;

	public static Object instance;
	
	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);

	public DarkRoleplayBlockMugBeer() {
		super(Material.wood);
	}

	static {

		blockMugBeer = new DarkRoleplayBlockMugBeer().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockMugBeer")
				.setStepSound(Block.soundTypeWood)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
				blockMugBeer.setBlockBounds(1.0F / 16F * 5F, 0.0F, 1.0F / 16F * 5F,1.0F / 16F * 11F, 1.0F / 16F * 7F, 1.0F / 16F * 11F);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityCustomMugBeer();
	}
	...
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockMugBeer, "blockMugBeer");
		GameRegistry.registerTileEntity(TileEntityCustomMugBeer.class, "TileEntityMugBeer");
	}
}

class TileEntityCustomMugBeer extends TileEntity {
}

class ItemRendererBlockMugBeer implements IItemRenderer {

	private ModelMugBeer model;

	public ItemRendererBlockMugBeer() {
		model = new ModelMugBeer();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(
				new TileEntityCustomMugBeer(), 0.0D, 0.0D, 0.0D, 0.0F);
	}

}

class customRendererMugBeer extends TileEntitySpecialRenderer {
