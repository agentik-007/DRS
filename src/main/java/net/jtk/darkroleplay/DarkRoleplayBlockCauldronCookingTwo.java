...
public class DarkRoleplayBlockCauldronCookingTwo extends BlockContainer {

	public static Block blockCauldronCookingTwo;

	public static Object instance;

	public DarkRoleplayBlockCauldronCookingTwo() {
		super(Material.wood);
	}

	static {

		blockCauldronCookingTwo = new DarkRoleplayBlockCauldronCookingTwo().setHardness(2.0F)
	...
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockCauldronCookingTwo, "blockCauldronCookingTwo");
...
class customRendererCauldronCookingTwo extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockCauldronCookingTwo.png");
...
class ModelCauldronCookingTwo extends ModelBase {
	//fields
  ...
  public ModelCauldronCookingTwo()
  {
    textureWidth = 128;
    textureHeight = 64;
