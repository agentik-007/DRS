...
public class DarkRoleplayBlockSmallFirepit extends BlockContainer {
	...
	public DarkRoleplayBlockSmallFirepit() {
		super(Material.wood);
	...
	static {
		...
		blockSmallFirepit = new DarkRoleplayBlockSmallFirepit()
	...
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockSmallFirepit, "blockSmallFirepit");
