...
public class customRendererKeyHanging extends TileEntitySpecialRenderer{
	private static final ResourceLocation texture = new ResourceLocation(DarkRoleplay.MODID, "textures/blockKeyHanging.png");
	
	private ModelKeyHanging model;

	public customRendererKeyHanging() {
		this.model = new ModelKeyHanging();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(KeyHanging.blockKeyHanging)){
			GL11.glPushMatrix();
