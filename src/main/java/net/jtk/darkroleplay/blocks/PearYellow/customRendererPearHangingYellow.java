...
public class customRendererPearHangingYellow extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(PearHangingYellow.blockPearHangingYellow)){
			GL11.glPushMatrix();
