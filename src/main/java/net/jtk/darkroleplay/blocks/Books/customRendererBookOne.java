...
public class customRendererBookOne extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(BookOne.blockBookOne)){
			GL11.glPushMatrix();
