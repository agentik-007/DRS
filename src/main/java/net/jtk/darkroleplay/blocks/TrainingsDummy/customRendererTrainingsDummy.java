...
public class customRendererTrainingsDummy extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(TrainingsDummy.blockTrainingsDummy)){
			GL11.glPushMatrix();
