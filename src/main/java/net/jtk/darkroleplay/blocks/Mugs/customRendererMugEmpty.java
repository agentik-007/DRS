...
public class customRendererMugEmpty extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(MugEmpty.blockMugEmpty)){
			GL11.glPushMatrix();
