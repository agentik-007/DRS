...
public class customRendererCauldronCookingOne extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(CauldronCookingOne.blockCauldronCookingOne)){
			GL11.glPushMatrix();
