...
public class customRendererCauldron extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(Cauldron.blockCauldron)){
			GL11.glPushMatrix();
