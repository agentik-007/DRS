...
public class customRendererCauldronCookingTwo extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(CauldronCookingTwo.blockCauldronCookingTwo)){
			GL11.glPushMatrix();
