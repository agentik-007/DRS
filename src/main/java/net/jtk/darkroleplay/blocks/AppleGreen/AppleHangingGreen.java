...
public class AppleHangingGreen extends BlockContainer {
	...
	public static Block blockAppleHangingGreen;
	...
	static {
		...
		blockAppleHangingGreen = new AppleHangingGreen().setHardness(0.2F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockAppleHangingGreen")
				.setStepSound(Block.soundTypeStone)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
				blockAppleHangingGreen.setBlockBounds(1.0F / 16F * 5F, 1.0F/16F*10F, 1.0F / 16F * 5F,1.0F / 16F * 11F, 1.0F / 16F * 16F, 1.0F / 16F * 11F);
	}
    ...
    {
		return DarkRoleplayFood.itemAppleGreen;
    }
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(AppleHangingGreen.blockAppleHangingGreen , 1), " X ", "   ", "   ", 'X', Items.apple);
	}
	
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockAppleHangingGreen, "blockAppleHangingGreen");
