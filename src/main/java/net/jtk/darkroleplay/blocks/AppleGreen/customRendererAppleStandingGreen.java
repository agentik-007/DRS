...
public class customRendererAppleStandingGreen extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockAppleStandingGreen.png");

	private ModelAppleStandingGreen model;

	public customRendererAppleStandingGreen() {
		this.model = new ModelAppleStandingGreen();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(AppleStandingGreen.blockAppleStandingGreen)){
			GL11.glPushMatrix();
...
class ModelAppleStandingGreen extends ModelBase {
	 //fields
  ...
  public ModelAppleStandingGreen()
  {
    textureWidth = 32;
    textureHeight = 32;
