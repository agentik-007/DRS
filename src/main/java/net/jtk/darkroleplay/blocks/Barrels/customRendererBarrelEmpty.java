...
public class customRendererBarrelEmpty extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(BarrelEmpty.blockBarrelEmpty)){
			GL11.glPushMatrix();
