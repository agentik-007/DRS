...
public class customRendererGrindstone extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(Grindstone.blockGrindstone)){
			GL11.glPushMatrix();
