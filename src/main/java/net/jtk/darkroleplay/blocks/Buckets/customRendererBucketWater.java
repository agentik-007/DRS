...
public class customRendererBucketWater extends TileEntitySpecialRenderer{
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockBucketWater.png");

	private ModelBucketWater model;

	public customRendererBucketWater() {
		this.model = new ModelBucketWater();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(BucketWater.blockBucketWater)){
			GL11.glPushMatrix();
...
class ModelBucketWater extends ModelBase
{
  //fields
