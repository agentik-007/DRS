...
public class customRendererAppleStandingRed extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockAppleStandingRed.png");

	private ModelAppleStandingRed model;

	public customRendererAppleStandingRed() {
		this.model = new ModelAppleStandingRed();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(AppleStandingRed.blockAppleStandingRed)){
			GL11.glPushMatrix();
...
class ModelAppleStandingRed extends ModelBase {
	 //fields
