...
public class customRendererAppleHangingRed extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockAppleHangingRed.png");

	private ModelAppleHangingRed model;

	public customRendererAppleHangingRed() {
		this.model = new ModelAppleHangingRed();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(AppleHangingRed.blockAppleHangingRed)){
			GL11.glPushMatrix();
...
class ModelAppleHangingRed extends ModelBase {
	 //fields
