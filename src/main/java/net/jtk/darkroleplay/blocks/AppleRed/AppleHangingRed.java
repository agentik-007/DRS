...
public class AppleHangingRed extends BlockContainer {

	public static Block blockAppleHangingRed;

	public static Object instance;

	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);
	
	public AppleHangingRed() {
		super(Material.wood);
	...
	static {
		...
		blockAppleHangingRed = new AppleHangingRed().setHardness(0.2F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockAppleHangingRed")
				.setStepSound(Block.soundTypeStone)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
				blockAppleHangingRed.setBlockBounds(1.0F / 16F * 5F, 1.0F/16F*10F, 1.0F / 16F * 5F,1.0F / 16F * 11F, 1.0F / 16F * 16F, 1.0F / 16F * 11F);
	}
