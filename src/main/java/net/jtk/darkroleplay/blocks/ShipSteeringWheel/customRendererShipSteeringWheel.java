...
public class customRendererShipSteeringWheel extends TileEntitySpecialRenderer {
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockShipSteeringWheel.png");

	private ModelShipSteeringWheel model;

	public customRendererShipSteeringWheel() {
		this.model = new ModelShipSteeringWheel();
	}
    @Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
    	if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(ShipSteeringWheel.blockShipSteeringWheel)){
			GL11.glPushMatrix();
