...
public class AppleStandingYellow extends BlockContainer {

	public static Block blockAppleStandingYellow;

	public static Object instance;

	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);
	
	public AppleStandingYellow() {
		super(Material.wood);
	...
	static {
		...
		blockAppleStandingYellow = new AppleStandingYellow().setHardness(0.2F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockAppleStandingYellow")
				.setStepSound(Block.soundTypeStone)
				.setLightOpacity(0)
				.setLightLevel(0.0F)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
				blockAppleStandingYellow.setBlockBounds(1.0F / 16F * 5F, 0.0F, 1.0F / 16F * 5F,1.0F / 16F * 11F, 1.0F / 16F * 6F, 1.0F / 16F * 11F);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityCustomAppleStandingYellow();
	}
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(AppleStandingYellow.blockAppleStandingYellow , 1), " X ", "   ", "   ", 'X', Items.apple);
	}
	
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockAppleStandingYellow, "blockAppleStandingYellow");
