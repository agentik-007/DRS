...
public class customRendererAppleHangingYellow extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockAppleHangingYellow.png");

	private ModelAppleHangingYellow model;

	public customRendererAppleHangingYellow() {
		this.model = new ModelAppleHangingYellow();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(AppleHangingYellow.blockAppleHangingYellow)){
			GL11.glPushMatrix();
...
class ModelAppleHangingYellow extends ModelBase {
	 //fields
  ...
  public ModelAppleHangingYellow()
  {
    textureWidth = 32;
    textureHeight = 32;
