...
public class customRendererAppleStandingYellow extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockAppleStandingYellow.png");

	private ModelAppleStandingYellow model;

	public customRendererAppleStandingYellow() {
		this.model = new ModelAppleStandingYellow();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(AppleStandingYellow.blockAppleStandingYellow)){
			GL11.glPushMatrix();
...
class ModelAppleStandingYellow extends ModelBase {
	 //fields
  ...
  public ModelAppleStandingYellow()
  {
    textureWidth = 32;
    textureHeight = 32;
