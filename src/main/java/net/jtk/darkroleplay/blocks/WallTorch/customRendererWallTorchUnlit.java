...
public class customRendererWallTorchUnlit extends TileEntitySpecialRenderer {
	private static final ResourceLocation texture = new ResourceLocation(DarkRoleplay.MODID, "textures/blockWallTorchUnlit.png");

	private ModelWallTorchUnlit model;
	private ModelWallTorchUnlitActive modelActive;

	public customRendererWallTorchUnlit() {
		this.model = new ModelWallTorchUnlit();
		this.modelActive = new ModelWallTorchUnlitActive();
	}
	@Override
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
			double z, float f, int i) {
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(WallTorchUnlit.blockWallTorchUnlit)){
			GL11.glPushMatrix();
...
class ModelWallTorchUnlit extends ModelBase
{
  //fields
...
class ModelWallTorchUnlitActive extends ModelBase
{
  //fields
    ModelRenderer Holder1;
    ModelRenderer Holder2;
  ...
  public ModelWallTorchUnlitActive()
  {
    textureWidth = 32;
    textureHeight = 32;
