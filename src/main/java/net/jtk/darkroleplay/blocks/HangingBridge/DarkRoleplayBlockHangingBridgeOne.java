...
public class DarkRoleplayBlockHangingBridgeOne extends BlockContainer {
	public static Block blockHangingBridgeOne;

	public static Object instance;

	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);
	
	public DarkRoleplayBlockHangingBridgeOne() {
		super(Material.wood);
	...
	static {
		...
		blockHangingBridgeOne = new DarkRoleplayBlockHangingBridgeOne().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockHangingBridgeOne")
				.setStepSound(Block.soundTypeStone)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
		blockHangingBridgeOne.setBlockBounds(1.0F / 16F * 0F, 0.0F, 1.0F / 16F * 0F,
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockHangingBridgeOne.blockHangingBridgeOne, 1), "Y Y", "Z Z", "XXX", 'X', Blocks.wooden_slab, 'Z', Items.string,'Y', DarkRoleplayBlockRope.blockRope);
	}
