...
public class HangingBridgeTwo extends BlockContainer {
	...
	static {
		...
		blockHangingBridgeTwo = new HangingBridgeTwo().setHardness(2.0F)
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(HangingBridgeTwo.blockHangingBridgeTwo, 1), "   ", "   ", " XZ", 'X', HangingBridgeOne.blockHangingBridgeOne, 'Z', Blocks.log);
	}
