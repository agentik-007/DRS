...
public class customRendererLargeFirepit extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(LargeFirepit.blockLargeFirepit)){
			GL11.glPushMatrix();
