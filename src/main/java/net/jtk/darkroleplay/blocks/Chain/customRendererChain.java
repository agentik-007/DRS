...
public class customRendererChain extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if(tileentity.getWorld().getBlockState(tileentity.getPos()).getBlock().equals(Chain.blockChain)){
			GL11.glPushMatrix();
