...
public class DarkRoleplayBlockBarrelClosed extends BlockContainer {

	public static Block blockBarrelClosed;

	public static Object instance;

	public DarkRoleplayBlockBarrelClosed() {
		super(Material.wood);
	}

	static {

		blockBarrelClosed = new DarkRoleplayBlockBarrelClosed().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockBarrelClosed")
				.setStepSound(Block.soundTypeWood)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
		blockBarrelClosed.setBlockBounds(1.0F / 16F * 0F, 0.0F, 1.0F / 16F * 0F,
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockBarrelClosed.blockBarrelClosed, 1), "XYX", "X X", "ZXZ", 'X', Blocks.planks, 'Z', Items.iron_ingot,'Y',Blocks.wooden_slab);
	}
...
class TileEntityCustomBarrelClosed extends TileEntity {
}

class customRendererBarrelClosed extends TileEntitySpecialRenderer {
