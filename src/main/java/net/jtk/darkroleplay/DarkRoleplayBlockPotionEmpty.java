...
public class DarkRoleplayBlockPotionEmpty extends BlockContainer {

	public static Block blockPotionEmpty;

	public static Object instance;

	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);
	
	public DarkRoleplayBlockPotionEmpty() {
		super(Material.wood);
	...
	static {
		...
		blockPotionEmpty = new DarkRoleplayBlockPotionEmpty().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockPotionEmpty")
				.setStepSound(Block.soundTypeGlass)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
				blockPotionEmpty.setBlockBounds(1.0F / 16F * 5F, 0.0F, 1.0F / 16F * 5F,1.0F / 16F * 11F, 1.0F / 16F * 9F, 1.0F / 16F * 11F);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityCustomPotionEmpty();
	}
	...
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockPotionEmpty, "blockPotionEmpty");
		GameRegistry.registerTileEntity(TileEntityCustomPotionEmpty.class, "TileEntityPotionEmpty");
	}
}

class TileEntityCustomPotionEmpty extends TileEntity {
}

class ItemRendererBlockPotionEmpty implements IItemRenderer {

	private ModelPotionEmpty model;

	public ItemRendererBlockPotionEmpty() {
		model = new ModelPotionEmpty();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance.renderTileEntityAt(
				new TileEntityCustomPotionEmpty(), 0.0D, 0.0D, 0.0D, 0.0F);
	}

}

class customRendererPotionEmpty extends TileEntitySpecialRenderer {
