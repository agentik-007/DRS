...
public class DarkRoleplayBlockGrindstone extends BlockContainer {
	...
	public DarkRoleplayBlockGrindstone() {
		super(Material.wood);
	...
	static {
		...
		blockGrindstone = new DarkRoleplayBlockGrindstone().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockGrindstone")
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityCustomGrindstone();
	}
...
class customRendererGrindstone extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockGrindstone.png");
