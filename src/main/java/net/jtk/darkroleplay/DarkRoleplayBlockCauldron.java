...
public class DarkRoleplayBlockCauldron extends BlockContainer {
	...
	public DarkRoleplayBlockCauldron() {
		super(Material.wood);
	...
	static {
		...
		blockCauldron = new DarkRoleplayBlockCauldron().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockCauldron")
				.setStepSound(Block.soundTypeMetal)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
		blockCauldron.setBlockBounds(1.0F / 16F * 1F, 1.0F / 16F * 0F, 1.0F / 16F * 1F,
				1.0F / 16F * 15F, 1.0F / 16F * 12F, 1.0F / 16F * 15F);
	}
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockCauldron.blockCauldron, 1), " X ", "X X", " Z ", 'X', Items.iron_ingot, 'Z', Blocks.iron_block);
	}
...
class customRendererCauldron extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			DarkRoleplay.MODID, "textures/blockCauldron.png");
