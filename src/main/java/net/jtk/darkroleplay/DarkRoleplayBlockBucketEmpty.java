...
public class DarkRoleplayBlockBucketEmpty extends BlockContainer {
	...
	public DarkRoleplayBlockBucketEmpty() {
		super(Material.wood);
	...
	static {
		...
		blockBucketEmpty = new DarkRoleplayBlockBucketEmpty().setHardness(2.0F)
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockBucketEmpty.blockBucketEmpty, 1), "X X", "X X", "XXX", 'X', Blocks.planks);
	}
...
class TileEntityCustomBucketEmpty extends TileEntity {
}

class customRendererBucketEmpty extends TileEntitySpecialRenderer {
