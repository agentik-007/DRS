...
public class DarkRoleplayBlockPearStandingYellow extends BlockContainer {

	public static Block blockPearStandingYellow;

	public static Object instance;
	
	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);

	public DarkRoleplayBlockPearStandingYellow() {
		super(Material.wood);
	...
	static {
		...
		blockPearStandingYellow = new DarkRoleplayBlockPearStandingYellow()
				.setHardness(0.2F).setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockPearStandingYellow")
				.setStepSound(Block.soundTypeStone)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
		blockPearStandingYellow.setBlockBounds(1.0F / 16F * 6F, 0.0F,
				1.0F / 16F * 6F, 1.0F / 16F * 10F, 1.0F / 16F * 6F,
				1.0F / 16F * 10F);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityCustomPearStandingYellow();
	}
	...
	public static void Init(FMLInitializationEvent event){
		GameRegistry.addRecipe(new ItemStack(DarkRoleplayBlockPearStandingYellow.blockPearStandingYellow , 1), "   ", "   ", " X ", 'X', DarkRoleplayFood.itemPear);
	}
	
	public static void preInit(FMLPreInitializationEvent event) {
		GameRegistry.registerBlock(blockPearStandingYellow,"blockPearStandingYellow");
		GameRegistry.registerTileEntity(TileEntityCustomPearStandingYellow.class, "TileEntityPearStandingYellow");
	}
}

class TileEntityCustomPearStandingYellow extends TileEntity {
}

class ItemRendererBlockPearStandingYellow implements IItemRenderer {

	private ModelPearStandingYellow model;

	public ItemRendererBlockPearStandingYellow() {
		model = new ModelPearStandingYellow();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		TileEntityRendererDispatcher.instance
				.renderTileEntityAt(new TileEntityCustomPearStandingYellow(),
						0.0D, 0.0D, 0.0D, 0.0F);
	}

}

class customRendererPearStandingYellow extends TileEntitySpecialRenderer {
