...
public class DarkRoleplayBlockBucketDirt extends BlockContainer {

	public static Block blockBucketDirt;

	public static Object instance;
	
	public static PropertyInteger DIR = PropertyInteger.create("dir", 0, 15);

	public DarkRoleplayBlockBucketDirt() {
		super(Material.wood);
	...
	static {
		...
		blockBucketDirt = new DarkRoleplayBlockBucketDirt().setHardness(2.0F)
				.setResistance(10.0F).setLightLevel(0.0F)
				.setUnlocalizedName("blockBucketDirt")
				.setStepSound(Block.soundTypeWood)
				.setCreativeTab(DarkRoleplayTabs.drBlocksTab);
		blockBucketDirt.setBlockBounds(1.0F / 16F * 3F, 0.0F, 1.0F / 16F * 3F,
...
class TileEntityCustomBucketDirt extends TileEntity {
}

class customRendererBucketDirt extends TileEntitySpecialRenderer {
